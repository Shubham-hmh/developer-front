                                ...
                                return (
                                    <div key={index} className="cart-data mb-2 py-3 d-flex justify-content-between align-items-center">
                                        <div className="cart-col-1  gap-15 d-flex align-items-center">
                                            <div className='w-25'> <img className='img-fluid' src={watch} alt="product image" /> </div>
                                            <div className='w-75'>
                                                <p>{item?.productId?.title}</p>
                                                <p className='d-flax gap-3'>Color: <ul className='colors ps-0'>
                                        ...
                                        <div className="cart-col-3 d-flex align-items-center gap-15">
                                            <div>
                                                <input min={1} max={10} type="number" name='quantity' className="form-control" value={productUpdateDetail?.cartItemId===item?._id ? productUpdateDetail?.quantity :  item?.quantity} onChange={(e)=>{setProductUpdateDetail({cartItemId:item?._id,quantity:e.target.value})}} />
                                            </div>
                                            <div>
