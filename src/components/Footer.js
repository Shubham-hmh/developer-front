...
const Footer = () => {
  return (
    <>
      <footer clasName="py-4">
        <div className="container-xxl ">
          <div className="row align-items-center news">
            <div className="col-5">
            ...
            <div className="input-group ">
                ...
                <span className="input-group-text p-2 mb-1" id="basic-addon2"><BsSearch className='fs-6' />Subscribe</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <Link to="/privacy-policy" className="text-white mb-1 py-2">Privacy Policy</Link>
                ...
                <Link to="/term-policy" className="text-white mb-1 py-2">Terms & Conditions</Link>
